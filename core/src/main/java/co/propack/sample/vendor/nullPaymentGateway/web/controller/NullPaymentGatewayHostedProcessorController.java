 ...
 * #L%
 */
package co.propack.sample.vendor.nullPaymentGateway.web.controller;

import co.propack.sample.payment.service.gateway.NullPaymentGatewayHostedConfiguration;
