...
-- This creates an empty new to Pro-Pack 
INSERT INTO BLC_PAGE (PAGE_ID, DESCRIPTION, PAGE_TMPLT_ID, FULL_URL) VALUES (3, 'New to Pro-Pack', 1, '/new-to-pro-pack');
...
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, VALUE) VALUES (2, CURRENT_TIMESTAMP, 'targetUrl', 1, '/supplements');
...
-- Fields
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, VALUE) VALUES (9, CURRENT_TIMESTAMP, 'htmlContent', 1, '<h2>PROTEIN AFICIONADO?</h2> Click to join our Customer Care Program. The place to get all the deals on supplements.');
...
-- Fields
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, VALUE) VALUES (11, CURRENT_TIMESTAMP, 'messageText', 1, 'Pro-Pack''s Top Selling Supplements');
...
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, VALUE) VALUES (13, CURRENT_TIMESTAMP, 'targetUrl', 1, '/supplements');
